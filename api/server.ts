...
// For Vercel, everything is in this file, we just need to export it.

// In development or non-Vercel production, we listen.
// We check for the root process to avoid listening multiple times in Vercel if it calls the entry point.
